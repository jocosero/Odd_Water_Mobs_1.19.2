...
public class HorseshoeCrabRenderer extends GeoEntityRenderer<HorseshoeCrabEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(HorseshoeCrabEntity instance) {
        return new ResourceLocation (OddWaterMobs.MOD_ID, "textures/entity/horseshoe_crab.png");
    }

    @Override
    public RenderType getRenderType(HorseshoeCrabEntity animatable, float partialTicks, PoseStack stack,
